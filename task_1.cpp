/*Пользователь вводит свое имя, фамилию, дату рождения, получает свой знак зодиака, а его данные записываются в map, 
для получения этих данных нужно ввести секретный символ i*/
#include <iostream>
#include <vector>
#include <string>
#include <map>
